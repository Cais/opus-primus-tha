<?php
/**
Plugin Name: Opus Primus THA
Plugin URI: http://opusprimus.com/features/stanzas/tha/
Description: Provide a bridge from the Theme Hook Alliance (THA) hooks
Version: 1.4
Author: Edward Caissie
Author URI: http://edwardcaissie.com/
Textdomain: opus-primus-tha-stanza
...
if ( file_exists( plugin_dir_path( __FILE__ ) . 'tha/tha-theme-hooks.php' ) ) {

	/** Grab the THA theme hooks file */
	require_once( plugin_dir_path( __FILE__ ) . 'tha/tha-theme-hooks.php' );
